...
in Github repository.
    ...
    [4] docs/html/index.html
		...
		* Link to repository: https://github.com/thuanbach/CS700Assignment1/blob/feature/average-score-all-exames/docs/html/index.html
	
	[5] TestRun1-Console.png: The screenshot of the test run 1.
	
	[6] TestRun1-CSV.png: The screenshot of the test run 1 for writing to csv file.
	
	[7] TestRun1-CSV-Opened-In-Excel: The screenshot of the test run 1 for writing to csv file, but opened in Excel program.
	
	[8] TestRun2-Console.png: The screenshot of the test run 2.
	
	[9] TestRun2-CSV.png: The screenshot of the test run 2 for writing to csv file.
	
	[10] TestRun2-CSV-Opened-In-Excel: The screenshot of the test run 2 for writing to csv file, but opened in Excel program.
	
	[11] GitHub-CS700Assignment1-Section1.png: The screenshot of the repository of the program for the section 1